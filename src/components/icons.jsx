...
export let starIcon = (
  <svg
    className="singleProductCard__star"
    xmlns="http://www.w3.org/2000/svg"
    viewBox="0 0 24 24"
    fill="currentColor"
  >
...
export let accountMenuIcon = (
  <svg
    ...
    strokeWidth={1.5}
    stroke="currentColor"
    className="accountMenuItem__icon"
  >
    <path
      strokeLinecap="round"
      strokeLinejoin="round"
...
export let visaCardIcon = (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    viewBox="0 0 50 50"
    className="accountContent__icon"
  >
